  ...
  (function() {
    ...
    for (
      var n = window,
        ...
        x = document,
        K = x.documentElement,
        L = x.head || x.getElementsByTagName("head")[0] || K,
        z = "",
        A = x.getElementsByTagName("script"),
        m = A.length;
      --m >= 0;
    ...
    z.replace(/[&?]([^&=]+)=([^&]+)/g, function(e, j, w) {
      ...
      j == "autorun"
        ...
        : j == "lang"
          ? D.push(w)
          : j == "skin" ? N.push(w) : j == "callback" && Q.push(w);
    });
    m = 0;
    ...
    var $ = (function() {
      ...
      (function() {
        ...
        i(C([], [["atv", /^[\S\s]+/]]), ["uq.val"]);
        i(t({ keywords: K, hashComments: !0, cStyleComments: !0, types: P }), [
          "c",
          "cc",
          "cpp",
          "cxx",
        ...
        i(t({ keywords: Q, cStyleComments: !0 }), ["java"]);
        ...
        i(t({ keywords: J, cStyleComments: !0, regexLiterals: !0 }), [
          "javascript",
          "js"
        ]);
        i(
        ...
        var X = (V.PR = {
          ...
          prettyPrint: (e = e = function(a, d) {
            function e() {
              ...
              p < j.length ? O(e, 250) : "function" === typeof a && a();
            }
            for (

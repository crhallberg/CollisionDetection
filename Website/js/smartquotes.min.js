...
(typeof "jQuery" == "function"
  ? jQuery
  : function(d) {
      var b = document.addEventListener || document.attachEvent,
      ...
      b.call(
        ...
        a,
        function() {
          document[c](a, arguments.callee, false);
          d();
        },
        false
      );
  ...
  while (b != null) {
    ...
    if (b.hasChildNodes() && b.firstChild.nodeName != "CODE") {
      b = b.firstChild;
    } else {
      do {
        while (b.nextSibling == null && b != a) {
          b = b.parentNode;
        }
        b = b.nextSibling;
      } while (
